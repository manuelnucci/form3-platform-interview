  ...
  microservices_config = [
    {
      ...
      "vault_config" : {
        ...
        "endpoint_password" : "${var.account_endpoint_password}"
      },
      "container_config" : {
        ...
        "environment_variables" : [
          ...
          "VAULT_USERNAME=${var.account_db_user}",
          "VAULT_PASSWORD=${var.account_db_password}",
        ],
        "exposed_ports" : null,
        "advanced_networking" : {
    ...
    },
    {
      ...
      "vault_config" : {
        ...
        "endpoint_password" : "${var.gateway_endpoint_password}"
      },
      "container_config" : {
        ...
        "environment_variables" : [
          "ENVIRONMENT=${local.environment}",
          "VAULT_ADDR=http://vault-${local.environment}:8200",
          "VAULT_USERNAME=${var.gateway_db_user}",
          "VAULT_PASSWORD=${var.gateway_db_password}",
        ],
        "exposed_ports" : null,
        "advanced_networking" : {
          "network_name" : "vagrant_development",
    ...
    },
    {
      ...
      "vault_config" : {
        ...
        "endpoint_password" : "${var.payment_endpoint_password}"
      },
      "container_config" : {
        ...
        "environment_variables" : [
          "ENVIRONMENT=${local.environment}",
          "VAULT_ADDR=http://vault-${local.environment}:8200",
          "VAULT_USERNAME=${var.payment_db_user}",
          "VAULT_PASSWORD=${var.payment_db_password}",
        ],
        "exposed_ports" : null,
        "advanced_networking" : {
          "network_name" : "vagrant_development",
